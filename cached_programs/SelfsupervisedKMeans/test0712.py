...
from SelfsupervisedKmeans0712 import  extract_shapelets_with_selfsupervised_learning
######## TO BE MODIFIED ######## TO BE MODIFIED ######## TO BE MODIFIED ######## TO BE MODIFIED ########
########################################################################################################

# HYPERPARAMETERS
shapelet_num_range = [50]
shapelet_len_prop_range = [.25]
learning_rate = 1e-3
num_batch = 8
num_epoch = 100
...
# DATASET
log_filename = 'SelfsupervisedKMeans-0712resnet-exp2.csv'
datasets = ['BeetleFly', 
            'Coffee', 
